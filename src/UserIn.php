...
$sql = "SELECT connection_id FROM websocket WHERE name LIKE '$name' and id = '$id' and is_driver = '$is_driver'";
...
if ($result->num_rows == 0) {
    ...
    $sql = "SELECT on_service FROM websocket WHERE name LIKE '$name' and id = '$id' and is_driver  '$is_driver'";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
